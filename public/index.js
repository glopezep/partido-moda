...
renderNotice(url).then(function (notices) {
  notices.forEach(function (notice) {
    var noticeTemplate = template.replace(':noticeImage:', notice.image).replace(':noticeType:', notice.type).replace(':noticeTitle:', notice.title).replace(':noticeText:', notice.text);
